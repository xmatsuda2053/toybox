...
import WaDropdownItem from "@awesome.me/webawesome/dist/components/dropdown/dropdown.js";
...
import styles from "@sn/styles/task/sn-task-current-status.lit.scss?inline";
