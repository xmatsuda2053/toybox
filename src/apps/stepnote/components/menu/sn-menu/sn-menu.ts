...
import styles from "@sn-menu/sn-menu/sn-menu.lit.scss?inline";

// Initializations
setBasePath("/");

// Configuration & Initialization ---
import mdIntroduction from "@sn-menu/help/introduction.md?raw";
import mdMenu from "@sn-menu/help/menu.md?raw";
import mdQuickAccess from "@sn-menu/help/quick-access.md?raw";
import mdLabels from "@sn-menu/help/labels.md?raw";
import mdLists from "@sn-menu/help/list.md?raw";
import mdTasks from "@sn-menu/help/task.md?raw";
import mdJournal from "@sn-menu/help/journal.md?raw";
