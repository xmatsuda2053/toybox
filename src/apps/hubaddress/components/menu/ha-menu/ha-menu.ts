...
import styles from "@ha-menu/ha-menu/ha-menu.lit.scss?inline";

// 6. Initializations
setBasePath("/");

// 7. Configuration & Initialization ---
import mdIntroduction from "@ha-menu/help/introduction.md?raw";
import mdMenu from "@ha-menu/help/menu.md?raw";
import mdSearch from "@ha-menu/help/search.md?raw";
import mdUploader from "@ha-menu/help/uploader.md?raw";
import mdViewer from "@ha-menu/help/viewer.md?raw";
